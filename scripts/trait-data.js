...
export const CATEGORY_PER_TRAIT = {
  ...
  anchoring: TC.SUBTYPE_MECHANIC,
  apparition: TC.BUILD_LIMITATION,
  attuned: TC.BUILD_LIMITATION,
  ...
  cycle: TC.SUBTYPE_MECHANIC,
  directive: TC.OCCASIONAL_MECHANIC,
  disharmony: TC.IMPORTANT_MECHANIC,
  ...
  manifestation: TC.SUBTYPE_MECHANIC,
  ...
  suppressed: TC.SUBTYPE_MECHANIC,
  ...
  analog: TC.OCCASIONAL_MECHANIC,
  archaic: TC.OCCASIONAL_MECHANIC,
  apex: TC.IMPORTANT_MECHANIC,
  artifact: TC.MOSTLY_FLUFF,
  barding: TC.SUBTYPE_MECHANIC,
  biotech: TC.VERY_FLUFF,
  ...
  retractable: TC.OCCASIONAL_MECHANIC,
  'shield-throw-20': TC.OCCASIONAL_MECHANIC,
  'shield-throw-30': TC.OCCASIONAL_MECHANIC,

  // Weapon Traits
  agile: TC.IMPORTANT_MECHANIC_OUTSIDE_CHAT,
  arc: TC.IMPORTANT_MECHANIC_OUTSIDE_CHAT,
  area: TC.IMPORTANT_MECHANIC_OUTSIDE_CHAT,
  automatic: TC.IMPORTANT_MECHANIC_OUTSIDE_CHAT,
  ...
  breakdown: TC.MOSTLY_FLUFF,
  brutal: TC.IMPORTANT_MECHANIC_OUTSIDE_CHAT,
  'boost-d4': TC.IMPORTANT_MECHANIC_OUTSIDE_CHAT,
  'boost-d6': TC.IMPORTANT_MECHANIC_OUTSIDE_CHAT,
  'boost-d8': TC.IMPORTANT_MECHANIC_OUTSIDE_CHAT,
  'boost-d10': TC.IMPORTANT_MECHANIC_OUTSIDE_CHAT,
  'boost-d12': TC.IMPORTANT_MECHANIC_OUTSIDE_CHAT,
  ...
  thought: TC.IMPORTANT_MECHANIC_OUTSIDE_CHAT,
  traversal: TC.SUBTYPE_MECHANIC,
  ...
  beast: TC.ORIGIN,
  celestial: TC.ORIGIN,
  construct: TC.IMPORTANT_MECHANIC,
  dragon: TC.ORIGIN,
  dream: TC.ORIGIN,
  elemental: TC.ORIGIN,
  ethereal: TC.ORIGIN,
  ...
  undead: TC.IMPORTANT_MECHANIC, // an origin that applies lots of mechanics
  ...
  jinsul: TC.SUB_ORIGIN,
  kaiju: TC.SUB_ORIGIN,
  kami: TC.SUB_ORIGIN,
  kobold: TC.SUB_ORIGIN,
  kovintus: TC.SUB_ORIGIN,
  kucharn: TC.SUB_ORIGIN,
  lilu: TC.SUB_ORIGIN,
  midwife: TC.SUB_ORIGIN,
  ...
  // Vehicle Traits
  motorized: TC.MOSTLY_FLUFF,
  pulled: TC.MOSTLY_FLUFF,
  rowed: TC.MOSTLY_FLUFF,
  wind: TC.MOSTLY_FLUFF,
