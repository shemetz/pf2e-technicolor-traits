...
export const TC_TOOLTIPS = Object.freeze({
  ...
  [TC.IMPORTANT_MECHANIC_OUTSIDE_CHAT]: 'Important but constantly appears in chat cards. e.g. Attack, Thrown, Subtle, Brutal, Reach, Finesse. (has rules, relevant in header)',
...
export const TC_NAMES = Object.freeze({
  ...
  [TC.IMPORTANT_MECHANIC_OUTSIDE_CHAT]: 'Important mechanic outside chat',
